...
interface ITimeswapBorrowCallbackInterface extends ethers.utils.Interface {
  functions: {
...
export class ITimeswapBorrowCallback extends BaseContract {
  ...
  interface: ITimeswapBorrowCallbackInterface;
